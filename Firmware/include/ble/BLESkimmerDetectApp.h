#ifndef BLEDetectSkimmerApp_H
#define BLEDetectSkimmerApp_H
...
enum BLESkimmerDetectAppState {
  BLE_SKIMMER_DETECT_STATE_HOME,
  BLE_SKIMMER_DETECT_STATE_RUNNING,
};

struct BLESkimmerDetectWebEventParams {
  const char* action;
};

class BLESkimmerDetectApp {
  private:
  ...
  public:
    ...
    static void webEvent(BLESkimmerDetectWebEventParams *ps);
